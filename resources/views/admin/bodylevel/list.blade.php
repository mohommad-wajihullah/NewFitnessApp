                                    ...
                                    <div id="myTable" class="dataTables_wrapper no-footer"><div id="table_id_filter" class="dataTables_filter"><label>Search:<input type="search" class="" placeholder="" aria-controls="table_id"></label></div>
                                        <table class="table all-package coupon-list-table table-hover theme-table dataTable no-footer" id="myTable">
                                            ...
                                            <tr><th class="sorting_disabled" rowspan="1" colspan="1" style="width: 170px;">#</th>
                                                ...
                                                <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 170px;"> Equipment</th>
                                                <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 170px;">Type Id</th>
                                                <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 170px;">Option</th></tr>
                                            </thead>

                                            <tbody>

                                            @foreach($bodyLevel as $key=> $type)
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="menu-status">
                                                        @if($type->with_equipment == 1)
                                                            <span class="success">With Equipment</span>
                                                        @else
                                                            <span class="danger">WithOut Euipment</span>
                                                        @endif
                                                    </td>
                                                    <td >
                                                        @if($type->type_id )
                                                    ...
                                                    <td>
                                                        <ul class="d-flex gap-2 list-unstyled">
                                                            ...
                                                            <li>
                                                                ...
                                                                <a href="{{route('bodylevel.edit',$type->id)}}" class="btn">
                                                                    <i class="ri-pencil-line"></i>
                                                                </a>


                                                                <form action="{{ route('bodylevel.destroy', $type->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
