                        ...
                        <div class="col-sm-10 m-auto">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{route('exerciseposition.update',$exercisePosition->id)}}" method="POST" >
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="theme-form theme-form-2 mega-form pt-4">
                                            <div class="theme-form theme-form-2 mega-form pt-4">
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea name="description" class="form-control" cols="5" >{{$exercisePosition->description}}</textarea>
                                                    </div>
                                                </div>
                                            ...
                                            <select name="exercise_id" class="form-select w-50 shadow-sm rounded-pill">
                                                @foreach ($exercise as $exercises)
                                                    <option value="{{ $exercises->id }}"
                                                        {{$exercisePosition->exercise_id == $exercises->id ? 'selected' : '' }}>
                                                        {{ $exercises->title }}
                                                    </option>
                                                @endforeach
                                            </select>
